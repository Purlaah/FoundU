...
document.querySelectorAll('.image-item').forEach(item => {
    ...
    item.addEventListener('mouseleave', function() {
        ...
        if (this.classList.contains('rotate-left')) {
            this.style.transform = 'rotate(-6deg) scale(1)';
        } else if (this.classList.contains('rotate-right')) {
            this.style.transform = 'rotate(3deg) scale(1)';
        } else if (this.classList.contains('rotate-left-small')) {
            this.style.transform = 'rotate(-3deg) scale(1)';
        }
    });
});
...
// Form validation (for future sign-up forms)
